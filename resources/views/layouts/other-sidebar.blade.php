<div class="left-area">
    ...
    <div class="left-humberger-menu ">
        <div class="sidebar">
            ...
            <ul>
                <li> <a href="{{ url('pm') }}"><i class="fa fa-dashboard"></i> Dashboard</a>
                </li>
                <li>
                    ...
                    <ul id="drop10" class="collapse">
                        ...
                        {{--                        </li>--}}
                        <li>
                            <a class="nav-link" href="{{ url('/pm') }}/today-orders"><i class="fa fa-angle-right" aria-hidden="true"></i>  Today Order's</a>
                        </li>
                        {{--                        <li>--}}
                        {{--                            <a class="nav-link" href="{{ url('ad/') }}/orders"><i class="fa fa-angle-right" aria-hidden="true"></i>  All Order Lists</a>--}}
                        {{--                        </li>--}}
                        <li>
                            <a class="nav-link" href="{{ url('/pm') }}/orders-light"><i class="fa fa-angle-right" aria-hidden="true"></i>  All Order Lists</a>
                        </li>
                        {{--                        <li>--}}
                ...
                <li > <a href="#" data-toggle="collapse" data-target="#drop1" class="drop" > Products <i class="fa fa-angle-down pull-right" aria-hidden="true"></i></a>
                    ...
                    <ul id="drop1" class="collapse">
                        ...
                        {{--                        </li>--}}
                        <li>
                            <a class="nav-link" href="{{ url('pm/add-product') }}"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Add Product</a>
                        </li>
                        <li>
                            <a class="nav-link" href="{{ url('pm/') }}/products"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Active  Product's</a>
                        </li>
                        {{--                        <li>--}}
                        ...
                        <li>
                            <a class="nav-link" href="{{ url('pm/') }}/inactive"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Inactive Product's</a>
                        </li>
                        {{--                        <li>--}}
...
{{--                </li>--}}
                <li> <a href="#" data-toggle="collapse" data-target="#drop211" class="drop"> Advertisement <i class="fa fa-angle-down pull-right" aria-hidden="true"></i></a>
                    ...
                    <ul id="drop211" class="collapse">
                        ...
                        <li>
                            <a class="nav-link" href="{{ url('pm/') }}/banner-add"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Home Advertisement Add</a>
                        </li>
                        <li>
                            <a class="nav-link" href="{{ url('pm/') }}/banner"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Home Advertisement List</a>
                        </li>
                        <li>
                            <a class="nav-link" href="{{ url('pm/') }}/category"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Add Advertisement with Category</a>
                        </li>
                        <li>
                            <a class="nav-link" href="{{ url('pm/') }}/category-lists"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Advertisement Category Lists</a>
                        </li>
                ...
                <li> <a href="#" data-toggle="collapse" data-target="#drop2" class="drop"> Settings <i class="fa fa-angle-down pull-right" aria-hidden="true"></i></a>
                    ...
                    <ul id="drop2" class="collapse">
                        ...
                        {{--                        </li>--}}
                        <li>
                            <a class="nav-link" href="{{ url('pm/') }}/sub-category"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Add Sub Category</a>
                        </li>
                        <li>
                            <a class="nav-link" href="{{ url('pm/') }}/sub-category-lists"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Sub Category Lists</a>
                        </li>
                        <li>
                            <a class="nav-link" href="{{ url('pm/') }}/child-category"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Add Child Category</a>
                        </li>
                        <li>
                            <a class="nav-link" href="{{ url('pm/') }}/child-cat-list"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Child Category Lists</a>
                        </li>

                        <li>
                            <a class="nav-link" href="{{ url('pm/') }}/brand"><i class="fa fa-angle-right" aria-hidden="true"></i> Add  brand</a>
                        </li>
                        <li>
                            <a class="nav-link" href="{{ url('pm/') }}/brand-lists"><i class="fa fa-angle-right" aria-hidden="true"></i> Brand  Lists</a>
                        </li>

                        {{--                        <li> <a href="{{ url('ad/terms-condition') }}"> Terms & Condition</a>--}}
                        {{--                        </li>--}}
                        <li>
                            <a href="{{ url('pm/add-unit') }}"> Add Unit</a>
                        </li>
                    </ul>
                </li>
