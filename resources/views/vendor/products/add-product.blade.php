        ...
        <div class="col-md-12">
                ...
                <div class="panel-body">
                    ...
                    @endif
                        ...
                        {!! Form::open(['url' => 've/vendor_create_product','class'=>'form-vertical','enctype'=>'multipart/form-data','files'=>true ]) !!}
                        {{ csrf_field() }}
                       <div class="row">
                           <div class="col-md-6">
                               <div class="form-group">
                                   <label for="name" class="col-form-label">Product Title (eng) <b style="color: red">*</b></label>
                                   <input type="text" class="form-control" name="name"   required autofocus>
                               </div>
                           </div>
                           <div class="col-md-6">
                               <div class="form-group">
                                   <label for="name" class="col-form-label">Product Title (bn)<b style="color: red">*</b></label>
                                   <input type="text" class="form-control" name="name_bn"   required>
                               </div>
                           </div>
                           <div class="col-md-6">
                               <div class="form-group">
                                   <label for="name" class="col-form-label">price <b style="color: red">*</b></label>
                           ...
                           <div class="col-md-6">
                               <div class="form-group relative-path">
                                   <label for="name" class="col-form-label">Sub category Name  <b
                                       ...
                                       <select class="form-control selectpicker" data-show-subtext="true"  name="sub_category_id[]" multiple=""  data-live-search="true">
                            ...
                            <div class="col-md-6">
                               <div class="form-group relative-path">
                                   <label for="name" class="col-form-label">Child Sub category Name </label>
                                       ...
                                       <select class="form-control selectpicker" data-live-search="true" name="child_sub_category_id[]" multiple="" >
                           ...
                           <div class="col-md-12 mt10">
                               <div class="form-group">
                                   ...
                                   <textarea  name="description" class="summernote form-control" rows="4"></textarea>
                               </div>
                           </div>
                           <div class="col-md-12">
