...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Lato&family=Quicksand:wght@500;515&family=Raleway:ital,wght@0,300;0,400;0,500;1,300&display=swap"
        rel="stylesheet">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Codystar&family=Raleway+Dots&family=Snippet&display=swap"
        rel="stylesheet">
...
<body style="background: #fff;padding:30px;">
    <span class="btn btn-block btn-sm btn-info printMe"
        style="border-radius: 0px;background: #e05544;border: 1px solid #de3c31;padding: 5px 0;font-size: 16px;"><i
            class="fa fa-print" aria-hidden="true"></i> PRINT INVOICE</span>
    <div id="app">
        <main>
            <div>
...
font-weight: 500;
line-height: 19px;
opacity: 1;"><img src="{{ url('/') }}/images/grasshopper-logo.png" alt="invoice icon" style="width: 136px;" /> <br>
                                    <small style="    font-size: 16px;color: #000;"> </small>
                                </h3>
...
width: 100%;" class="color">
                                ...
                                <p style="margin: 0 0 0px;">
                                    <span
                                        style="font-size: 12px;letter-spacing: 1px;">{{ $order_custumer->phone}}</span>
                                </p>
                                <p style="margin: 0 0 0px;">
                            ...
                            <div class="productsarea">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            @foreach ($products as $product) @if($order_product->product_id
                                            ==$product->id)
                                            <td colspan="3">
                                                @if($order_product->custom_name_bn)
                                                {{$order_product->custom_name_bn}}
                                                @else
                                                {{$product->name_bn}} {{$product->strength}} {{$product->unit_quantity}}
                                                {{$product->unit}} <span style="text-transform: capitalize;">
                                                    @endif
                                                    ...
                                                    @endif
                                                    <br> {{ $order_product->quantity }} &#215;
                                                    &#2547;{{ number_format((float)$order_product->unit_price, 2, '.', '') }}
                                            ...
                                            <td>
                                                <span
                                                    style="text-transform: capitalize;float: right;text-align: right;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right;color: #e05544;font-weight: 600;"
                                                class="color">
                                        ...
                                        <tr>
                                            <td colspan="3" class="text-right"
                                                style="font-weight: bold;color: #e05544;">
                                                মোট
                                            </td>
                                            <td style="text-align: right;color: #e05544;font-weight: 600; border-top: 1px dashed #ccc !important;"
                                                class="color">
