                    ...
                    <div class="panel-body">
                        ...
                        @endif
                            @if(Auth::user()->role === 'admin')
                                {!! Form::open(['url' => 'ad/order/custom_product_add','class'=>'form-vertical','enctype'=>'multipart/form-data','files'=>true ]) !!}
                            @elseif(Auth::user()->role ==='manager')
                                {!! Form::open(['url' => 'pm/order/custom_product_add','class'=>'form-vertical','enctype'=>'multipart/form-data','files'=>true ]) !!}
                            @elseif(Auth::user()->role ==='author')
                                {!! Form::open(['url' => 'au/order/custom_product_add','class'=>'form-vertical','enctype'=>'multipart/form-data','files'=>true ]) !!}
                        ...
                        <table id="order_products" class="table table-striped table-bordered">
                            ...
                            <tr>
                                <td colspan="4">
                                    <input type="text" name="delivery_dicsount" placeholder="coupon Discount" class="form-control" />
                                </td>
                                <td colspan="2">
                        ...
                        <tr v-for="(product, index) in  products" :id="'row_'+product.id" class="toy">
                            <td class="text-center">
                                ...
                                <img :src="'https://gopalganjbazar.com/web/uploads/products/' +product.featured_image"
                                     width="45px"></td>
                            <td class="p_name_bn">!{product.name_bn}! !{product.unit_quantity}!!{product.unit}!</td>
