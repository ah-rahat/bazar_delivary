...
{{--                            <a target="_blank" href="today-orders/delivered/{{date('Y-m-d',strtotime("0 days"))}}" class="btn btn-sm btn-success pull-right mr15">TODAY DELIVERED ORDERS</a>--}}
                        </div>
                                    ...
                                    @foreach ($orders  as $order)
                                        <tr>
                                            <td class="bolder">
                                                ...
                                                @if(Auth::user()->role === 'admin')
                                                    <a style="color: #388e3c;" href="https://gopalganjbazar.com/web/ad/order/{{$order->order_id}}">#{{$order->order_id}}
                                                        @if($order->coupon)
...
padding: 3px 6px;
border-radius: 2px;
border: 1px solid rgb(129, 199, 132);" title="Order Details" target="_blank" href="https://gopalganjbazar.com/web/ad/order/{{$order->order_id}}" class="btn btn-sm"><i class="fa fa-rocket"></i></a>
                                                @elseif(Auth::user()->role === 'manager')
                                                    <a style="color: rgb(56, 142, 60);
background: rgb(200, 230, 201) none repeat scroll 0% 0%;
padding: 3px 6px;
