        ...
        var app = new Vue({
            ...
            methods: {
                getProducts: function () {
                    ...
                    axios.get('{{url('/')}}' + '/api/active-product-lists')
                ...
                fetchData: function (page_number) {
                    ...
                    axios.get('{{url('/')}}' + "/api/active-product-lists?page=" + page_number)
                        .then(function (response) {
                            // handle success
                ...
                searchProducts: function () {
                    var vm = this;
                    axios.get('{{url('/')}}' + '/api/active-product-lists?data=' + this.searchData)
