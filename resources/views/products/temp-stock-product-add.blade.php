                                    ...
                                    <table class="table stocklising">
                                        ...
                                        <tr>
                                            <th style="border: none; font-size: 14px;border: 1px solid #e8e8e8 !important;"
                                                colspan="8">Purchase Product's List
                                            <span style="color: rgb(233, 30, 99);" class="pull-right">TOTAL BUY: {{$temp_stocks_price->total_buy_price}}TK</span>
                                            </th>
                                        </tr>
                                        <tr>
                                            <td class="comment">
                                        ...
                                        @foreach($temp_stocks as $temp_stock)
                                            @foreach($products as $product)
                                                @if($product->id == $temp_stock->product_id)
                                            ...
                                            <tr>
                                                ...
                                                <td class=" taken  text-center" style="color:  rgb(233, 30, 99);font-size: 14px;">
                                                    {{$temp_stock->quantity}}
                                                </td> <td class=" taken  text-center" style="color:  rgb(233, 30, 99);font-size: 14px;">
                                                    {{$temp_stock->total_buy_price}}
                                                </td>

                                                <td class=" taken  text-center" style="color:  rgb(233, 30, 99);font-size: 14px;">
                                                    {{$temp_stock->total_buy_price/$temp_stock->quantity}}
                                                </td>
                                                <td class=" taken  text-center" style="color:  rgb(233, 30, 99);font-size: 14px;">
                                                ...
                                                <td class=" taken  text-center" style=" #0f7706; font-size: 14px;">
                                                    <div>
                                                        {{$product->buy_price}}
                                                    </div>
                                                ...
                                                <td>
                                                    <a href="temp-instock-products-delete/{{$temp_stock->id}}" title="DELETE" class="btn btn-sm btn-danger"><i class="fa fa-trash-o"></i></a>
                                                </td>
                ...
                <div class="modal-dialog" style="max-width: 376px !important;">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            <b>Name:</b>
                            <p class="thisproductName"></p>
                            <b>Expire Date:</b>
                            <p class="modal_expire_date"></p>
                        ...
                        <div class="modal-footer" style="border: none; text-align: center;">
                            <button type="button" onclick="updateExpireDate()" class="btn btn-success">Save Expire
                                Date
                            </button>
        ...
        var app = new Vue({
            ...
            methods: {
                ...
                selectProducts: function (index, product_id, productName) {
                    ...
                    axios.get('https://gopalganjbazar.com/web/au/products/findsales/' + product_id,
                        {
                            data: '_token = <?php echo csrf_token() ?>'
                        })
                    @endif
                ...
                updateStock: function () {
                    ...
                    @elseif(Auth::user()->role === 'author')
                    axios.get('https://.com/web/au/products/stock/' + vm.date + '/' + vm.product_id + '/' + vm.stock_quantity + '/' + vm.price,
                        {
                            data: '_token = <?php echo csrf_token() ?>'
                        })
                    @endif
            ...
            jQuery('#myModal').on('click', '#sore_in_stock_btn', function () {
                ...
                if (product_id != '' && date != '' && price != '' && stock_quantity != '') {
                    jQuery.ajax({
                        ...
                        @elseif(Auth::user()->role === 'author')
                        url: 'https://gopalganjbazar.com/web/au/products/temp-stock/' + date + '/' + product_id + '/' + stock_quantity + '/' + price,
                        @endif
                        dataType: "json",
                        data: '_token = <?php echo csrf_token() ?>',
