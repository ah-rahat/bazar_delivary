                        ...
                        <div class="panel-body">
                            <div>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                    <tr v-for="(stockList, index) in stockLists" @click="openExpireModal(stockList.product_stock_id,stockList.expire_date)">
...
@section('footerjs')
    ...
    <script>
            ...
            jQuery('#myModal').on('click', '#sore_in_stock_btn', function () {
                ...
                if (product_id != '' && date != '' && price != '' && stock_quantity != '') {
                    jQuery.ajax({
                        type: 'GET',
                        @if(Auth::user()->role === 'admin')
                        url: 'https://gopalganjbazar.com/web/ad/products/stock/' + date + '/' + product_id + '/' + stock_quantity + '/' + price,
                        @elseif(Auth::user()->role === 'manager')
                        url: 'https://gopalganjbazar.com/web/pm/products/stock/' + date + '/' + product_id + '/' + stock_quantity + '/' + price,
                        @endif
                        dataType: "json",
                        data: '_token = <?php echo csrf_token() ?>',
        ...
        jQuery('.add_stock_btn').click(function () {
            ...
            var price = jQuery("#price").val();
            var stock_quantity = jQuery("#stock_quantity").val();
            if (product_id != '' && date != '' && price >= 0 && stock_quantity != '') {
