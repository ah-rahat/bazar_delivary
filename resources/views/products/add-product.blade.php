...
@if(Auth::user()->role === 'admin')
                        {!! Form::open(['url' => 'ad/create_product','class'=>'form-vertical','enctype'=>'multipart/form-data','files'=>true ]) !!}
 @elseif(Auth::user()->role === 'manager')                      
                         {!! Form::open(['url' => 'pm/create_product','class'=>'form-vertical','enctype'=>'multipart/form-data','files'=>true ]) !!}
                        @elseif(Auth::user()->role === 'author')
                            {!! Form::open(['url' => 'au/create_product','class'=>'form-vertical','enctype'=>'multipart/form-data','files'=>true ]) !!}
...
{{--                           </div>--}}
                           ...
                           <div class="col-md-4">
                               <div class="form-group ">
                                   ...
                                   <input type="number" class="form-control" name="stock_quantity" step=any   required>
                               </div>
                           </div>
                           <div class="col-md-6">
                               <div class="form-group relative-path">
