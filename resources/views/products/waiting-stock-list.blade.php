            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default simple-panel">
                        <div class="panel-heading">Add New Product In waiting List</div>
...
{{--                            {!! Form::close() !!}--}}
                ...
                <div class="col-md-12 mt10">
                    <div class="panel panel-success">
                        <div class="panel-heading">Products List <b class="pull-right">Total: {{ $total }}</b></div>
                        <div class="panel-body">
                            <div>
                                    ...
                                    @foreach ($products as $product)
                                        ...
                                        <tr>
                                            ...
                                            <td  class="text-center">
                                                ...
                                                @if(Auth::user()->role === 'admin')
                                                    <a class="btn-sm btn-warning " href="/web/ad/del_waiting_list/{{$product->id}}"><i class=" fa fa-trash-o"></i></a>

                                                @elseif(Auth::user()->role === 'manager')

                                                    <a class="btn-sm btn-warning " href="/web/pm/del_waiting_list/{{$product->id}}"><i class="fa fa-trash-o"></i></a>
        ...
        methods: {
          updateProducts: function (index, product_id,productName) {
            ...
            //alert(vm.total_buy_price);
              @if(Auth::user()->role === 'admin')
              axios.get('https://gopalganjbazar.com/web/ad/save_waiting_list/' + vm.product_id+'/'+vm.quantity+'/'+vm.total_buy_price,
                @elseif(Auth::user()->role === 'manager')
                axios.get('https://gopalganjbazar.com/web/pm/save_waiting_list/' + vm.product_id+'/'+vm.quantity+'/'+vm.total_buy_price,
                  @endif
              {
