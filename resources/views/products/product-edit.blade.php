                ...
                <div class="col-md-12">
                    <div class="panel panel-default simple-panel">
                        ...
                        <div class="panel-body">
                            ...
                            @if(Auth::user()->role === 'admin')
                                {!! Form::open(['url' => 'ad/update_product','class'=>'form-vertical','enctype'=>'multipart/form-data','files'=>true ]) !!}


                            @elseif(Auth::user()->role === 'manager')
                                {!! Form::open(['url' => 'pm/update_product','class'=>'form-vertical','enctype'=>'multipart/form-data','files'=>true ]) !!}
                            @endif
                            {{ csrf_field() }}
                            <input type="hidden" name="id" value="{{$product->id}}"/>
                            <input type="hidden" name="real_stock" value="{{$product->real_stock}}"/>
...
{{--                                                    style="color: red">*</b></label>--}}
{{--                                        @if($product->real_stock == 1)--}}
{{--                                            <input type="text" class="form-control" readonly value="{{$product->buy_price}}"/>--}}
{{--                                        @else--}}
{{--                                            <input type="text" class="form-control" name="buy_price" value="{{$product->buy_price}}"/>--}}
{{--                                        @endif--}}
{{--                                        @if(Auth::user()->role === 'admin')--}}
{{--                                            <input type="text" class="form-control"--}}
{{--                                                   @if($product->real_stock == 1) readonly @endif name="buy_price"--}}

{{--                                                   value="{{$product->buy_price}}"/>--}}
{{--                                        @else--}}
{{--                                            <input type="text" class="form-control" readonly>--}}
{{--                                            <input type="hidden" class="form-control" name="buy_price"--}}
