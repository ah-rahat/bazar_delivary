            ...
            <div class="row justify-content-center">
                <div class="col-md-12 mt30">
                    <div class="panel panel-success">
                        <div class="panel-heading">In Stock Products List</div>
                            ...
                            <div>
                                <table id="example" class="table table-striped regulatList">
                                    ...
                                    @foreach ($products as $product)
                                        ...
                                        <tr id="{{$product->id}}">
                                            <td><img src="{{ url('/uploads/products') }}/{{$product->featured_image}}"
                                                     width="55px"></td>
                                            ...
                                            <td class="main_price"> &#2547; <span>{{$product->price }}</span></td>
                                            <td class="main_price"> &#2547; <span>{{ $product->discount }}</span></td>


                                            <td @if($product->price - $product->discount < $product->buy_price) style="background: red;" @endif>
                                                @if(Auth::user()->role === 'admin')
                                                    <input type="text" readonly class="form-control price"
                                            ...
                                            <td>
                                                @if(Auth::user()->role === 'admin')
                                                    ...
                                                    <input type="text" class="form-control lowStockQuantity"
                                                           title="LOW Stock Quantity" placeholder="LOW Stock"
                                                ...
                                                <td>
                                                    @if(Auth::user()->role === 'admin')
                                                        <a class="btn btn-sm btn-info pull-right"
                                                           href="products/{{$product->id}}"><i class="fa fa-rocket"></i></a>
                                                    @endif
                                                </td>
                                                <td>
                                                    @if(Auth::user()->role === 'admin')
                                                        <button type="button"
                                                                class="btn-sm btn-warning pull-right update_price"
                                                                data-id="{{$product->id}}" style="margin-right: 5px;">
                                                            UPDATE
                                                        </button>
                                                    @endif
                                                </td>
