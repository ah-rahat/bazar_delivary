                                    ...
                                    @foreach ($orders  as $order)
                                        <tr>
                                            <td class="bolder">
                                                ...
                                                @if(Auth::user()->role === 'admin')
                                                    <a style="color: #388e3c;" href="https://gopalganjbazar.com/web/ad/shop/order/{{$order->order_id}}">#{{$order->order_id}}
                                                        @if($order->coupon)
                                                            <small style="text-transform: uppercase;"> - {{$order->coupon}}</small>
                                                        @endif
                                                    </a>
                                                @else
                                                    <a style="color: #388e3c;" href="https://gopalganjbazar.com/web/shop/order/{{$order->order_id}}">#{{$order->order_id}}
                                                        @if($order->coupon)
                                                            <small style="text-transform: uppercase;"> - {{$order->coupon}}</small>
                                                        @endif
                                                    </a>
...
padding: 3px 6px;
border-radius: 2px;
border: 1px solid rgb(129, 199, 132);" title="Order Details" target="_blank" href="https://gopalganjbazar.com/web/ad/shop/order/{{$order->order_id}}" class="btn btn-sm"><i class="fa fa-rocket"></i></a>
...
padding: 3px 6px;
border-radius: 2px;
border: 1px solid rgb(129, 199, 132);" title="Order Details" target="_blank" href="https://gopalganjbazar.com/web/shop/order/{{$order->order_id}}" class="btn btn-sm"><i class="fa fa-rocket"></i></a>
