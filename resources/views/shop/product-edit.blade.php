        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default simple-panel">
                    <div class="panel-heading">Shop Update Product </div>
                    <div class="panel-body">
                        ...
                        {!! Form::open(['url' => 'shop/update_product','class'=>'form-vertical','enctype'=>'multipart/form-data','files'=>true ]) !!}

                        {{ csrf_field() }}
                        <input type="hidden" name="id" value="{{$product->id}}"/>
                        <input type="hidden" name="real_stock" value="1"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name_bn"
                                           value="{{$product->name_bn}}" required >
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
